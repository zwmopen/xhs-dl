...
1. Run `一键安装V2.bat` from the 万能下载器 release folder when the dedicated Xiaohongshu engine is not ready.
...
- Visual interface: run `万能下载器.exe` from the application folder.
