...
- Process only public links supplied or authorized by the user.
- Do not collect private, deleted, access-controlled, or unrelated account content.
- Do not request account passwords, session cookies, browser profiles, or API secrets.
